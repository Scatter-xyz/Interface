...
export const FooterData = () => {
  return (
    <div className="w-full h-content">
        <div className="bg-greenKelp-500 grid place-items-center h-full pt-8 md:pt-10 xl:pt-14 pb-6 md:pb-8 xl:pb-12">
          <div>
            <p className="text-center font-sans font-semibold text-white text-3xl md:text-5xl">Join our community</p>
            <p className="text-center text-white text-sm md:text-lg xl:text-lg p-4 md:p-8 lg:p-10">Chat with the team and others in the community to learn more about fractional.art and help shape the future of the fractional protocol.</p>
            <div className="flex items-center sm:justify-center flex-col sm:flex-row">        
              ...
              <div className="flex flex-col items-center justify-center rounded-lg h-20 w-28 sm:h-20 sm:w-36 md:h-32 md:w-48 lg:h-32 lg:w-48 xl:h-40 xl:w-64 m-2 md:m-6 xl:m-10 flex items-center justify-center bg-greenKelp-100 hover:bg-gin-400">
  ...
  return (
    <div className="rounded-lg shadow-lg bg-white w-fit mb-6" key={data.originalAddress + "-" + data.tokenID}>
        <div>
          {
            data.imageLoading ? (
              <div className="animate-pulse flex items-center justify-center h-48 w-64 sm:h-56 sm:w-80 md:h-64 md:w-80 lg:h-72 lg:w-72">
                <svg className="h-40 w-56 sm:h-48 sm:w-72 md:h-56 md:w-72 lg:h-60 lg:w-60 rounded-lg bg-gray-200" viewBox="0 0 24 24"/>
              </div>
            ) : (
              <img className="rounded-t-lg h-48 w-64 sm:h-56 sm:w-80 md:h-64 md:w-80 lg:h-72 lg:w-72" src={data.nftImage} alt=""/>
            ) 
          }
        </div>
        <div>
          <div className="px-4 pt-2">
            <div className="flex flex-row">
                <p className="text-emerald-700 text-sm font-normal md:font-semibold mb-2">Original Address: </p>
            ...
            <div className="flex flex-row">
                <p className="text-emerald-700 text-sm font-normal md:font-semibold mb-2">Fraction Address: </p>
                <div className="flex-1" />
            ...
            <div className="flex flex-row">
                <p className="text-emerald-700 text-sm font-normal md:font-semibold mb-2">Token Id:</p>
                <div className="flex-1" />
                <p className="text-sm text-emerald-900">{data.tokenID}</p>
            </div>
            <div className="flex flex-row">
                <p className="text-emerald-700 text-sm font-normal md:font-semibold mb-2">Fraction Count:</p>
                <div className="flex-1" />
...
const RecentActivity = ({fractionData}) => {
  if(fractionData && fractionData.length > 0) {
    return (
      <div className="bg-gin-50 flex justify-center p-10">
        <div className="w-11/12">
          <div className="flex flex-row items-center md:mx-14 lg:mx-10 xl:mx-16">
            <div className="text-lg sm:text-xl md:text-3xl text-greenKelp-400 font-semibold">Recent Activity</div>
            <div className="flex-1"></div>
...
export default function Home() {
  ...
  return (
    <div>
      ...
      <main>
        <Navbar/>
        <div className="flex flex-col lg:flex-row pt-20 bg-gin-50 h-content">
          <div className="flex flex-col justify-center items-center w-full h-2/6 lg:w-1/2 md:h-1/2 lg:h-5/6 p-10 pt-20 pb-0 sm:p-12 sm:pt-20 sm:pb-2 md:p-20 md:pb-2 md:pt-28 lg:p-28 lg:pt-36">
            <div className="text-center text-lg sm:text-xl md:text-4xl lg:text-5xl xl:text-6xl text-greenKelp-400 font-bold font-sans">
              <Link href="/fractionalise"><a className="text-stiletto-300 hover:text-stiletto-500"> Fractionalise</a></Link>, 
              <Link href="/trade"><a className="text-stiletto-300 hover:text-stiletto-500"> Trade </a></Link> 
              or 
              <Link href="/merge"><a className="text-stiletto-300 hover:text-stiletto-500"> Merge </a></Link>
              your NFTs 
            </div>
            <div className="text-sm text-center sm:text-lg md:text-2xl lg:text-2xl xl:text-3xl mt-2 md:mt-8 lg:mt-10 text-greenKelp-400">
          ...
          <div className="relative flex justify-center items-center w-full h-2/6 lg:w-1/2 md:h-1/2 lg:h-5/6 p-12 md:p-20 lg:p-24">
            <div className="flex justify-center items-center h-64 w-64 md:h-84 md:w-84 lg:h-96 lg:w-96 pr-10">
              <img src="WAW.png" className="rounded-lg mr-32 sm:mr-60 md:mr-60 lg:mr-60 xl:mr-80 blur-sm absolute w-36 h-36 sm:w-44 sm:h-44 md:w-52 md:h-52 lg:w-72 lg:h-72"/>
              <img src="murakamiFlower.png" className="rounded-lg ml-32 sm:ml-60 md:ml-60 lg:ml-60 xl:ml-80 blur-sm absolute w-36 h-36 sm:w-44 sm:h-44 md:w-52 md:h-52 lg:w-72 lg:h-72"/>
              <img src="WowG.png" className="absolute rounded-lg w-44 h-44 sm:w-52 sm:h-52 md:w-60 md:h-60 lg:w-80 lg:h-80 "/>
            </div>
          </div>
        </div>
        <div className="flex flex-col items-center p-4 bg-gin-100 pb-10 pt-10"> 
          <div className="sm:text-xl md:text-3xl lg:text-4xl font-semibold text-greenKelp-400 text-center"> <span className="text-stiletto-300">Collective</span> ownership of iconic and historic NFTs</div>
          <div className= "mt-6 text-sm md:text-base lg:text-xl font-medium text-greenKelp-400 text-center">Fractionalization is also a unique way to unlock NFT liquidity and community building around popular NFTs.</div>
        </div>
