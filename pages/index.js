    ...
    <div>
      ...
      <main>
        ...
        <div className="flex flex-col items-center px-4 bg-gin-100 py-4 md:py-6 lg:py-8"> 
          ...
          <div className= "sm:px-10 md:px-6 mt-2 md:mt-4 text-base md:text-xl lg:text-2xl fond-semibold text-greenKelp-400 text-center">Fractionalization allows new investers to be part of the community and increases the overall adoption.</div>
        </div>
